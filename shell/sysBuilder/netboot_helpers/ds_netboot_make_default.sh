...
do
  ...
  do
    ...
    then
      ...
      then
        echo "Setting '${NETBOOT_SET_NAME}' as the default NetBoot set..."
        defaults write "${NETBOOT_SET_PATH}/NBImageInfo" IsDefault -bool YES
      else
        echo "Setting '${NETBOOT_SET_NAME}' as alternative NetBoot set..."

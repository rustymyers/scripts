...
if   test -d "$OSMAIN"
      ...
      mkdir /Users/rusty/Logs/osmaintain
fi
...
if [ $answer = "n" ]
      ...
      read DISKWHAT
      echo -e "The disc partition "$DISKWHAT" is being repairedc"
      echo -e ". Please Waitr"
...
##
      ...
      update_prebinding -root $START -debug >/Users/rusty/Logs/osmaintain/prebind 2>&1
      sleep 2
      echo -e "Pre-binding Finished. r"

##
# System Maintenance from OS X Set to run at 3 am.
# The computer is never on then. This runs that maintenance.
##
      echo -e "Periodic Maintenance Starting...r"
      echo -e " t Daily Maintenance...c"
      periodic daily >/Users/rusty/Logs/osmaintain/daily 2>&1
      sleep 1
      echo -e "Finished r"
      echo -e " t Weekly Maintenance...c"
      periodic weekly >/Users/rusty/Logs/osmaintain/weekly 2>&1
      sleep 1
      echo -e "Finished r"
      echo -e " t Monthly Maintenance...c"
      periodic monthly >/Users/rusty/Logs/osmaintain/monthly 2>&1
      sleep 1
      echo -e "Finished r"

#tag Class
Protected Class CocoaMenuItemWritingDirectionBaseRightToLeft
Inherits CocoaMenuItem
	#tag Event
		Function ActionSelectorName() As String
		  return "makeBaseWritingDirectionRightToLeft:"
		End Function
	#tag EndEvent
	...
	#tag Constant, Name = LocalizedText, Type = String, Dynamic = True, Default = \"\tRight to Left", Scope = Public
		...
		#Tag Instance, Platform = Any, Language = nl, Definition  = \"\tRechts naar links"
	#tag EndConstant

#tag Class
Protected Class CocoaMenuItemTextAlignRight
Inherits CocoaMenuItem
	...
	#tag Constant, Name = LocalizedText, Type = String, Dynamic = True, Default = \"Align Right", Scope = Public
		#Tag Instance, Platform = Any, Language = en, Definition  = \"Align Right"
		#Tag Instance, Platform = Any, Language = de, Definition  = \"Rechtsb\xC3\xBCndig"
